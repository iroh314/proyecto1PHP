                    ...
                    <?php if(isset($_POST["botonCalcular"])):?>
                        ...
                        <?php 
                            ...
                            if($imc < 18.5){
                                ...
                                $mensaje = "Obesidad de tipo III (Morbida)";
                            }
                            else if ($imc >= 49.9 ){
                                $mensaje = "Obesidad de tipo IV (extrema)";
                            }
                            else {
                                $mensaje = "Datos invalidos, ingrese de nuevo la información";
                            }
                        
                        ?>
                            <h3 class = "resultado"><?php echo("Su imc = " .round($imc,2)) ?></h3>
                            <h1 class = "resultado"><?php echo($mensaje) ?></h1>
